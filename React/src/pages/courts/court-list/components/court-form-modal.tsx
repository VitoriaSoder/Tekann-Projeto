...
import {
  COURT_TYPE_SELECT_OPTIONS,
  quadraSchema,
  QuadraFormData,
} from "@/features/quadras/schemas/quadraSchema";
        ...
        <DialogContent className="sm:max-w-[540px] bg-card border border-border rounded-[32px] p-0 gap-0 overflow-hidden">
          <Box className="bg-muted/30 px-10 py-8 border-b border-border">
            <DialogTitle asChild>
              <Heading
                level={2}
                tKey="courts:form_title"
                className="text-xl font-extrabold text-foreground tracking-tight m-0"
              />
            </DialogTitle>
            <DialogDescription asChild>
              <Text
                variant="muted"
                tKey="courts:form_description"
                className="mt-1"
              />
            </DialogDescription>
          </Box>
            ...
            >
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          {...field}
                          placeholder={t("courts:region_placeholder")}
                          className="rounded-xl h-11 bg-background border-border"
                        />
                      </FormControl>
                      <FormMessage className="text-destructive text-xs" />
              ...
              <DialogFooter className="pt-4 border-t border-border flex gap-3 mt-4">
                <Button
                  ...
                  className="flex-1 rounded-full h-11 font-medium text-muted-foreground"
                >
                  <Text
                    variant="bold"
                    tKey="common:cancel"
                ...
                <Button
                  ...
                  className="flex-1 h-11 rounded-full bg-primary hover:bg-primary/90 text-black font-black uppercase tracking-tight disabled:opacity-60 shadow-md shadow-primary/10"
                >
                  {form.formState.isSubmitting ? (
                    <Text
                      variant="none"
                      tKey="courts:creating"
                      as="span"
                      className="text-sm"
                    />
                  ) : (
