    ...
    <Box className="py-24 bg-muted/30 overflow-hidden">
      <Container>
        <Box className="flex flex-col items-center text-center mb-20">
          <Heading
            level={2}
            className="text-3xl md:text-5xl font-bold tracking-tighter text-foreground mb-8"
          >
            <Text
              as="span"
              variant="inherit"
              tKey="common:landing.mockups.title1"
            />{" "}
            <Text
              as="span"
              variant="none"
              tKey="common:landing.mockups.title2"
              className="text-primary"
            />
          </Heading>
          <Text
            variant="muted"
            tKey="common:landing.mockups.subtitle"
