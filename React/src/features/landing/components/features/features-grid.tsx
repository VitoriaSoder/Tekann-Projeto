      ...
      <div className="container px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-xl">
            <Heading
              level={2}
              className="text-3xl md:text-4xl font-bold tracking-tight text-foreground leading-tight mb-4"
            >
              <Text
                as="span"
                variant="inherit"
                tKey="common:landing.features.title1"
              />
              <br />
              <Text
                as="span"
                variant="none"
                tKey="common:landing.features.title2"
          ...
          <div className="max-w-xs">
            <Text
              variant="muted"
              tKey="common:landing.features.subtitle"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featuresData.map((feature, index) => (
            ...
            >
              <div className="mb-6 w-12 h-12 rounded-xl bg-card flex items-center justify-center text-foreground group-hover:bg-primary group-hover:text-primary-foreground transition-colors shadow-sm">
                <feature.icon
                  size={24}
                  strokeWidth={2.5}
