      ...
      <div className="container px-6">
        ...
        <div className="flex justify-center">
          <Link to="/auth/register">
            <Button
              size="lg"
              className="h-16 px-12 rounded-full border-2 border-border hover:bg-accent hover:text-accent-foreground bg-card text-foreground font-black uppercase tracking-widest transition-all hover:scale-105 flex items-center gap-3"
            >
              <Text
                variant="bold"
                as="span"
